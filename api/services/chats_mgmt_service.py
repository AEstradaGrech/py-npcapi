...
class ChatsMgmtService:
    ...
    async def insert_chat_event(self, chat_id:str, category:str, event_tag:str, message:str, turn_id:int = None) -> bool:
        details_repo = ChatDetailsRepository(self._currentDB)
    ...
    async def set_current_session_chat_status(self, session_id: str, status:bool):
        repo = ChatSessionsRepository(db_name=self._currentDB)
    ...
    async def set_current_session_chat_status_by_chat_id(self, chat_id: str, status:bool):
        sessions_repo = ChatSessionsRepository(db_name=self._currentDB)
        chats_repo = ChatPromptsRepository(db_name=self._currentDB)
